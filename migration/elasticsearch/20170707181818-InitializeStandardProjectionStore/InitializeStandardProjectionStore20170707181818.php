...
final class InitializeStandardProjectionStore20170707181818 implements MigrationInterface
{
    ...
    public function getDescription(string $direction = self::MIGRATE_UP): string
    {
        return $direction === self::MIGRATE_UP
            ? 'Create the Elasticsearch index for the Dlx-Security context.'
            : 'Delete the Elasticsearch index for the Dlx-Security context.';
    }
    ...
    private function up(): void
    {
        ...
        $this->putMappings($index, [
            'dlx-security-migration_list' => $this->loadFile('migration_list-mapping-20170707181818.json')
        ]);
    }
